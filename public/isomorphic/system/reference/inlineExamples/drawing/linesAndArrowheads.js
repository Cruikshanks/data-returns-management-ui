    ...
    items: [
        {
            ...
            changed : function (form, self, value) {
                drawItems.map("setLineWidth", value);
            }
        },
        {
            name: "linePattern",
            ...
            changed : function (form, self, value) {
                drawItems.map("setLinePattern", value);
            }
        },
        {
            name: "lineCap",
            ...
            changed : function (form, self, value) {
                drawItems.map("setLineCap", value);
            }
        },
        {
            name: "lineColor",
            ...
            changed : function (form, self, value) {
                drawItems.map("setLineColor", value);
            }
        },
        {
            name: "arrowHeadStyle",
            ...
            changed : function (form, self, value) {
                drawItems.map("setStartArrow", value);
                drawItems.map("setEndArrow", value);
            }
        }
    ]
});
